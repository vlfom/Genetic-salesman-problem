...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->btn_start->Text = L"Розпочати пошук";
			...
			this->btn_reset->Text = L"Завершити пошук";
			...
			this->btn_openFile->Text = L"Відкрити граф з файлу";
			...
			this->btn_clear->Text = L"Очистити поле";
			...
			this->btn_continue->Text = L"Продовжити пошук";
			...
			this->iterationsNumberDesc->Text = L"Номер ітерації:";
			// 
			// elapsedTimeDesc
			// 
			...
			this->elapsedTimeDesc->Text = L"Витрачений час:";
			// 
			// iterationsNumberVal
			// 
			...
			this->pathLengthDesc->Text = L"Довжина поточного найкращого шляху:";
			// 
			// controlsGroup
			// 
			...
			this->controlsGroup->Text = L"Контроль програми";
			// 
			// btn_algo_opts
			// 
			...
			this->btn_algo_opts->Text = L"Параметри алгоритму";
			...
			this->btn_saveFile->Text = L"Зберегти граф до файлу";
			...
			this->mutationHistoryGroup->Text = L"Історія кращих мутацій";
			// 
			// labelDescBigField
			// 
			...
			this->labelDescBigField->Text = L"Вершини графу:";
			// 
			...
			this->labelDescSmallFields->Text = L"Батьки найкращого представника:";
			// 
			// infoGroup
			// 
			...
			this->infoGroup->Text = L"Інформація про роботу програми";
			// 
			// btn_returnToMain
			// 
			...
			this->btn_returnToMain->Text = L"Повернутся до головного меню";
			...
			this->workWithGraphGroup->Text = L"Робота з графом";
			// 
			// MyForm
			// 
			...
			this->Text = L"Вирішення задачі комівояжера";
...
#pragma endregion
	...
	private: System::Void btn_start_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (problem->nodes.size() < 10) {
			MessageBox::Show("Граф повинен містити хоча б 10 вершин", "Notification", MessageBoxButtons::OK, MessageBoxIcon::Asterisk);
			return;
		}
	...
	private: System::Void timer_Tick(System::Object^  sender, System::EventArgs^  e) {
		...
		if (getIteration.gotBetter) {
			...
			mutationListBox->Items->Add(" " + Convert::ToString(iterationsCount) + "  ітерація");
